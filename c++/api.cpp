...
// Define Callbacks
static void (*event_perform)     (int, int)                                       = nullptr;
static int  (*ds_map_create)     (int, ...)                                       = nullptr;
static bool (*ds_map_add_double) (int index, const char *key, double       value) = nullptr;
static bool (*ds_map_add_string) (int index, const char *key, const char  *value) = nullptr;
